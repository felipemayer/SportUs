    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                LoginManager.getInstance().logInWithReadPermissions(NewLogInActivity.this, Arrays.asList("email", "public_profile", "user_friends"));
        ...
        buttonLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.matches("")) {
                    Toast.makeText(NewLogInActivity.this, "Ops, esqueceu do E-MAIL", Toast.LENGTH_LONG).show();
                } else if (password.matches("")) {
                    Toast.makeText(NewLogInActivity.this, "Opa, esqueceu a SENHA", Toast.LENGTH_LONG).show();
                } else {
                            ...
                            .addOnCompleteListener(NewLogInActivity.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (!task.isSuccessful()) {
                                        ...
                                        Toast.makeText(NewLogInActivity.this, "Hmm, algo está errado.",
